...
class ResultsScreen extends InputComponent {
 ...
 getButtons() {
   const slideNumber = this.state.slide;
    if (slideNumber === 5){
      return (<div className="bottomButtons"><div onClick={this.props.quit()} className="continueButton">Ciao</div></div>);
    } else if (slideNumber === 0) {
      return (<div className="bottomButtons"><div onClick={this.nextSlide} className="continueButton">Next</div></div>);
    } else {
      return (<div className="bottomButtons"><div onClick={this.nextSlide} className="continueButton">Next</div><div onClick={this.backSlide} className="continueButton">Back</div></div>);
    }
  }
  render() {
    return(
